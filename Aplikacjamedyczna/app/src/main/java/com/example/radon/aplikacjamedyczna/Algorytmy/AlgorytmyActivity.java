...
import com.example.radon.aplikacjamedyczna.Skale.AdapterSkale;
 ...
 */
public class AlgorytmyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_algorytmy);

        mDrawerLayout = (DrawerLayout)findViewById(R.id.drawer_layout);
        mDrawerList = (ListView)findViewById(R.id.navList);

        //set adapter for drawer list
        MenuAdapter drawerAdapter = new MenuAdapter(this,4);
        mDrawerList.setAdapter(drawerAdapter);


        //set adapter for scale list
        AdapterAlgorytmy adapter = new AdapterAlgorytmy(this);
        ListView myList = (ListView) findViewById(R.id.listView_algorytmy);
